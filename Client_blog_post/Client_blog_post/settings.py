"""
Django settings for Client_blog_post project.
...
SECRET_KEY = 'django-insecure-&h1n^$s^tu^%gs%vw7(6@$++!b(i3qp1jo)ugg$*9+^t0=v$=u'
...
ROOT_URLCONF = 'Client_blog_post.urls'
...
WSGI_APPLICATION = 'Client_blog_post.wsgi.application'
